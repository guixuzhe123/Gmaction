...
<div class="panel panel-danger" style="margin:50px auto;min-width:1000px;width:90%;">
    <form method="post" action="<?php echo U('Home/Reg/hour_data');?>">
        ...
        <table class="table table-bordered" style="text-align:center;vertical-align:middle;">
            ...
            <tbody>
                <?php if(is_array($rs)): $i = 0; $__LIST__ = $rs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($vo["sid"]); ?></td>
                    <td><?php echo ($vo["date"]); ?></td>
                    <td><?php echo ($vo["role_h0"]); ?></td>
                    <td><?php echo ($vo["role_h1"]); ?></td>
                    <td><?php echo ($vo["role_h2"]); ?></td>
                    <td><?php echo ($vo["role_h3"]); ?></td>
                    <td><?php echo ($vo["role_h4"]); ?></td>
                    <td><?php echo ($vo["role_h5"]); ?></td>
                    <td><?php echo ($vo["role_h6"]); ?></td>
                    <td><?php echo ($vo["role_h7"]); ?></td>
                    <td><?php echo ($vo["role_h8"]); ?></td>
                    <td><?php echo ($vo["role_h9"]); ?></td>
                    <td><?php echo ($vo["role_h10"]); ?></td>
                    <td><?php echo ($vo["role_h11"]); ?></td>
                    <td><?php echo ($vo["role_h12"]); ?></td>
                    <td><?php echo ($vo["role_h13"]); ?></td>
                    <td><?php echo ($vo["role_h14"]); ?></td>
                    <td><?php echo ($vo["role_h15"]); ?></td>
                    <td><?php echo ($vo["role_h16"]); ?></td>
                    <td><?php echo ($vo["role_h17"]); ?></td>
                    <td><?php echo ($vo["role_h18"]); ?></td>
                    <td><?php echo ($vo["role_h19"]); ?></td>
                    <td><?php echo ($vo["role_h20"]); ?></td>
                    <td><?php echo ($vo["role_h21"]); ?></td>
                    <td><?php echo ($vo["role_h22"]); ?></td>
                    <td><?php echo ($vo["role_h23"]); ?></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
    </div>
