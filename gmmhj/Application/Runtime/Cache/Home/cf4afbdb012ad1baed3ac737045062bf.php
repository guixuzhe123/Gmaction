...
<div class="panel panel-danger" style="margin:50px auto;min-width:1000px;width:90%;">
    <div class="panel-heading">
        ...
        <select name='status' id="status" selectst="<?php echo ($status); ?>">
            ...
            <?php if(is_array($status_list)): $i = 0; $__LIST__ = $status_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option class="statusoption" value='<?php echo ($vo["id"]); ?>' uhref="<?php echo U('Apply/apply_list',array('status' => $vo['id']));?>"><?php echo ($vo["label"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
    ...
    <div class="panel-body">
        <table class="table table-bordered" style="text-align:center;vertical-align:middle;">
            ...
            <tbody>
				<form method="post" action="<?php echo U('Apply/review');?>">
